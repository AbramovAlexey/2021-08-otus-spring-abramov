...
public class BookRepositoryJPATest {
    ...
    void shouldReturnBooksWithGenreName(){
        List<Book> books = bookRepository.findWithGenreName(EXISTING_GENRE_NAME);
        assertThat(books).hasSize(1);
        assertThat(books.get(0)).hasFieldOrPropertyWithValue("id", EXISTING_BOOK_ID);
        books = bookRepository.findWithGenreName("Name not exists");
    ...
    void shouldReturnBooksWithAuthorName(){
        List<Book> books = bookRepository.findWithAuthorName(EXISTING_AUTHOR_NAME);
        assertThat(books).hasSize(1);
        assertThat(books.get(0)).hasFieldOrPropertyWithValue("id", EXISTING_BOOK_ID);
        books = bookRepository.findWithAuthorName("Name not exists");
        assertThat(books).hasSize(0);
    }
